...
```{r}
mollusk_tree <- read.tree()
annelid_tree <- read.tree()
gastro_tree <- read.tree()
```
...
root_A_write <- write.tree(root_A, file = "~/Desktop/root_A.tre")
root_M_write <- write.tree(root_M, file = "~/Desktop/root_M.tre")
root_G_write <- write.tree(root_G, file = "~/Desktop/root_G.tre")
plot(root_A)
root_A$tip.label
root_M$tip.label
root_G$tip.label
...
plot(constraint)
constraint_tree <- write.tree(constraint, file = "~/Desktop/Struck_Giribet_Con.tre")
```
...
root_con <- write.tree(root_con, file = "~/Desktop/rooted_constraint")
root_con$tip.label
```
